...
export function GoalManager(props: Props) {
  ...
  const updateIconOnChange = (emoji: any) => {
  ...
  return (
    <GoalManagerContainer>
      ...
      {icon && <GoalIcon icon={icon} onClick={() => setShowEmojiPicker(true)} />}
      {<AddIconButton hasIcon={!!icon} onClick={() => setShowEmojiPicker(true)} />}
      {showEmojiPicker && <EmojiPicker onClick={updateIconOnChange} />}
